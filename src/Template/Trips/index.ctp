...
-->
<h1>My trips
    <button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#tripAdd">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h2 class="modal-title">Add a trip</h2>
                </div>
                <form class="form-horizontal" method="post" accept-charset="utf-8">
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input class="form-control" id="tripName" placeholder="Trip Name" ng-model="tripToAdd.name">
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer" id="tripNameBTN">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                        <button type="submit" class="btn btn-primary" ng-click="addTrip()" data-target="#tripParticipants" data-dismiss="modal">Save</button>
                    </div>
                </form>
            </div><!-- /.modal-content -->
        </div><!-- /.modal-dialog -->
                            ...
                            <div class="modal-content">
                                ...
                                <form class="form-horizontal" method="post" accept-charset="utf-8">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="submit" class="btn btn-primary" ng-click="loadTrips()" data-dismiss="modal">Close</button>
                                    </div>
                                </form>
                            </div><!-- /.modal-content -->
                        </div><!-- /.modal-dialog -->
