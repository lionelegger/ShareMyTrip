...
class ActionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'notes' => ['type' => 'text', 'length' => 4294967295, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null],
        'price' => ['type' => 'decimal', 'length' => 5, 'precision' => 2, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => ''],
    ...
    public $records = [
        [
            ...
            'price' => 1.5,
            'currency' => 'L',
            'start_date' => '2016-12-29 15:14:14',
            'start_name' => 'Lorem ipsum dolor sit amet',
            'start_long' => 1.5,
            'start_lat' => 1.5,
            'end_date' => '2016-12-29 15:14:14',
